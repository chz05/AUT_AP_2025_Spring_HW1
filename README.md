...
# **First Question: File Organizer Script**
...
### **Second Question: Sorting Points by Euclidean Distance**
...
- **Euclidean Distance Calculation:**  
  ...
  \]
  *Note:* Since you are only comparing distances, you can compare the squared values (`x*x + y*y + z*z`) to avoid computing the square root.
...
### **Third Question: Counting Islands in a 2D Grid**
